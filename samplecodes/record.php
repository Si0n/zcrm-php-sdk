...
class Record
{
    ...
    public function convert()
    {
        ...
        $details = ['overwrite' => TRUE, 'notify_lead_owner' => TRUE, 'notify_new_entity_owner' => TRUE, 'Accounts' => '3524033000001055001', 'Contacts' => '3524033000001248867', 'assign_to' => '3524033000000191017'];
    ...
    public function getRelatedListRecords()
    {
        ...
        $header_map = ['if-modified-since' => '2019-10-10T15:26:49+05:30']; // key-value pair containing all the headers - optional
    ...
    public function getNotes()
    {
        $record = ZCRMRestClient::getInstance()->getRecordInstance('{module_api_name}', '{record_id}'); // To get record instance
        $param_map = ['page' => '1', 'per_page' => '200']; // key-value pair containing all the parameters - optional
        $header_map = ['if-modified-since' => '2019-12-12T15:26:49+05:30']; // key-value pair containing all the headers - optional
